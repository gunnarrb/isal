...
%\lstset{escapechar =\%}
%\lstset{escapebegin=\color{ForestGreen}\%}
...
\subsection*{Bilanir}
Samkvæmt verkefnislýsingunni \cite{verkefnislysing} er það nokkuð slembið hvaða vélar bila, að vél F undanskilinni, og að bilanir eiga sér stað nokkrum sinnum á vakt. Gildið á tölunni \emph{nokkrum sinnum} er illa skilgreint en höfundar sammæltust um töluna 8. Fyrir flestar bilanir er viðgerðartíminn 5 til 30 mínútur. Í einhverjum tilfellum þarf að ræsa út viðgerðarmann ef um stórar bilanir er að ræða og slíkar bilanir geta varað í nokkrar klukkustundir. Engin önnur gögn liggja fyrir um bilanir eða tíðni þeirra og þar sem að gögnin eru ekki nákvæmari voru eftirfarandi forsendur gefnar:
...
Þessu er lýst á Mynd 2. Vélar B og C geta unnið tvö skaut í einu. \cite{verkefnislysing} \\ 
...
Vinnslutími vélar er sá tími sem líður milli þess að skaut kemur að lausri vél og fer frá vélinni aftur. Færslutími er sá tími sem líður milli þess að skaut fer frá vél og kemur að næstu vél. Þeir eru reiknaðir út samkvæmt gagnaskjali, \cite{millitimaskjal}.
...
\bibitem{verkefnislysing}
 Starfsmaður Ísal,
  \emph{HermunIsal\_2011\_r2.pdf}.
  2011.
  
  \bibitem{millitimaskjal}
 Starfsmaður Ísal,
  \emph{Millitimar.xls}.
  2011.
\end{thebibliography}
